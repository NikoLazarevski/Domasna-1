...
public class DataCompletionFilter implements Filter<List<Company>> {
    ...
    public DataCompletionFilter(CompanyRepository companyRepository, CompanyDataRepository companyDataRepository) {
    ...
    private void addHistoricalData(Company company, LocalDate fromDate, LocalDate toDate) throws IOException, ParseException {
