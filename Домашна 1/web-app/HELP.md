...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.3.5/reference/companyData/sql.html#companyData.sql.jdbc)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.3.5/reference/companyData/sql.html#companyData.sql.jpa-and-spring-companyData)
...
* [Using Spring Data JDBC](https://github.com/spring-projects/spring-companyData-examples/tree/master/jdbc/basics)
* [Accessing Data with JPA](https://spring.io/guides/gs/accessing-companyData-jpa/)
